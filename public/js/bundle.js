...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFya2hvZmZtYW4iLCJhIjoiY2wycmh0MHFxMDA1cjNubGFueHN3a2ZzNCJ9.vuESCSvUKpiYyMvLidUimw';
  var map = new mapboxgl.Map({
    /* https://docs.mapbox.com/mapbox-gl-js/api/map/ */
    container: 'map',
    style: 'mapbox://styles/markhoffman/cl2u6howt003w14qlvp5nsfht',
    scrollZoom: false // center: [-118, 34], // long,lat
    // zoom: 5,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // 3. Add popup (marker's info)

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // 4. Extends map bounds to include the current location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Incorrect email or password'); // console.log(error);
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            URL = "/api/v1/users/logout"; // userRoutes
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('password-confirm-reg').value;
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // form is Object: { name: ... , email... , photo: ... }
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // auto converted 'data-tour-id' to 'tourId'
